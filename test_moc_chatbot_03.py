...
class MOC_bot2(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.driver = webdriver.Ie(executable_path="C:/Users/QA/Desktop/work/Завдання У ПРОЦЕССІ/MOC site/Autotest/Drivers/IEDriverServer_x64_3.14.0/IEDriverServer.exe")
